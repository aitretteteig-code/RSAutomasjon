# REG-004 MA - Svinn kilovare (21 kode)

Set: Regresjon
Default environment: Test
Source reference: KOBT-2766 - https://norgesgruppen.atlassian.net/browse/KOBT-2766
Area: Mobile Access
Priority: Normal
Status: NOT RUN
...
Registrere svinn for kilovare med 21-kode i Mobile Access.
...
2. Scan en 21-strekkode og registrer arsaks kode, antall og fritekst.
...
Testen passerer nar 21-kode-svinn er sendt og verifisert i logg, rapport og lagerbevegelser.
...
Jira-informasjon hentet og strukturert fra KOBT-2766 2026-05-07. Ingen execution er utfort ved import.